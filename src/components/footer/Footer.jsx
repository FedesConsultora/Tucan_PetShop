...
const Footer = () => {
  ...
  const baseMapUrl =
    'https://www.google.com/maps/d/u/0/embed?mid=1TbN9jFojVaEFzMfSoK7zYTYg99NZ_sU&ehbc=2E312F&noprof=1';
  ...
  const locations = [
    {
      ...
      fullAddress: '',
      plusCode: '4233+RR Gonnet, Provincia de Buenos Aires',
      lat: -34.893770,
      lng: -58.008701,
      embedUrl:
        'https://www.google.com/maps/d/u/0/embed?mid=1TbN9jFojVaEFzMfSoK7zYTYg99NZ_sU&ehbc=2E312F&noprof=1&ll=-34.893770,-58.008701&z=17',
    },
    {
      id: 1,
      name: '32 e/ 6 y 7',
      fullAddress: '',
      plusCode: '422J+2R La Plata, Provincia de Buenos Aires',
      lat: -34.898283,
      lng: -57.981124,
      embedUrl:
        'https://www.google.com/maps/d/u/0/embed?mid=1TbN9jFojVaEFzMfSoK7zYTYg99NZ_sU&ehbc=2E312F&noprof=1&ll=-34.898283,-57.981124&z=17',
    },
    {
      id: 2,
      name: '18 esq. 50',
      fullAddress: '',
      plusCode: '32GQ+2J La Plata, Provincia de Buenos Aires',
      lat: -34.923331,
      lng: -57.974149,
      embedUrl:
        'https://www.google.com/maps/d/u/0/embed?mid=1TbN9jFojVaEFzMfSoK7zYTYg99NZ_sU&ehbc=2E312F&noprof=1&ll=-34.923331,-57.974149&z=17',
    },
  ];

  const currentMapUrl = activeLocation !== null ? locations[activeLocation].embedUrl : baseMapUrl;

  const handleLocationClick = (id) => {
    setActiveLocation((prev) => (prev === id ? null : id));
    // Scroll map into view on mobile where it sits above the address list
    if (mapRef.current) {
      setTimeout(() => {
            ...
            <div className="footer__map-placeholder" ref={mapRef}>
              ...
              {activeLocation !== null && (
                <div className="footer__map-card">
                  <button
                    className="footer__map-card__close"
                  ...
                  <div className="footer__map-card__body">
                    <div className="footer__map-card__pin">
                    ...
                    <div className="footer__map-card__info">
                      <h4 className="footer__map-card__name">
                        {locations[activeLocation].name}
                      </h4>
                      {locations[activeLocation].fullAddress && (
                        <p className="footer__map-card__address">
                          {locations[activeLocation].fullAddress}
                        </p>
                      )}
                    </div>
                  ...
                  <div className="footer__map-card__divider" />

                  <div className="footer__map-card__actions">
                    <a
                      href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(locations[activeLocation].plusCode)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="footer__map-card__btn footer__map-card__btn--primary"
                    >
                    ...
                    <a
                      href={`https://www.google.com/maps?q=${encodeURIComponent(locations[activeLocation].plusCode)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="footer__map-card__btn footer__map-card__btn--secondary"
                    >
                      Ver en Maps
                    </a>
                  </div>
            ...
            <div className="footer__info-grid">
              ...
              <div className="footer__col footer__col--locations">
                {locations.map((loc) => (
                  <button
                    key={loc.id}
                    className={`footer__location-item ${activeLocation === loc.id ? 'is-active' : ''}`}
              ...
              <div className="footer__col footer__col--social">
                <a
                  href="https://www.instagram.com/tucansuperdemascotas/"
                  target="_blank"
                  rel="noopener noreferrer"
